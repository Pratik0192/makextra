  ...
  return (
    <div className='mx-2 md:mx-4 lg:mx-8 xl:mx-96 mt-5 md:mt-5'>
      ...
      <div className='text-gray-500 mt-6 flex flex-col gap-2'>
        ...
        <p>● You can reach us by sending an email at <span className='font-bold'>help@makextra.in</span> or a text message on WhatsApp <span className='font-bold'>(+91 9330597272)</span></p>
