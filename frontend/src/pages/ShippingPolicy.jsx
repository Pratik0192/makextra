  ...
  return (
    <div className='mx-8 md:mx-16 lg:mx-32 xl:mx-96 mt-5 md:mt-5'>
      ...
      <div className="text-gray-500">
        ...
        <p>At Makextra, we aim to provide efficient and reliable shipping for all orders. Please review our shipping details below:</p>
        ...
        <p>While we strive for timely delivery, Makextra is not responsible for delays caused by carriers, weather, customs processes, or other circumstances beyond our control. If your order is delayed, please contact our support team for assistance.</p>
        <p className='font-bold mb-2 mt-4'>6. Incorrect Address</p>
        <p>Please ensure your shipping address is accurate at checkout. Makextra is not responsible for lost or delayed shipments due to incorrect addresses.</p>
